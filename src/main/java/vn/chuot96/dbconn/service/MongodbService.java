...
import static vn.chuot96.dbconn.constant.MongodbUri.MONGODB;
...
import vn.chuot96.dbconn.util.MongodbHandler;
...
public class MongodbService {
    ...
    public ResponseEntity<?> insert(NosqlRequest request) {
    ...
    public ResponseEntity<?> find(NosqlRequest request) {
        return handler.handleMongoOperation(MONGODB.setUri(request), client -> {
    ...
    public ResponseEntity<?> update(NosqlRequest request) {
        return handler.handleMongoOperation(MONGODB.setUri(request), client -> {
    ...
    public ResponseEntity<?> delete(NosqlRequest request) {
        return handler.handleMongoOperation(MONGODB.setUri(request), client -> {
