package vn.chuot96.dbconn.util;

import static vn.chuot96.dbconn.constant.SqlConfigParam.DEFAULT_SELECT_LIMIT;
...
import vn.chuot96.dbconn.compo.SqlConnectionPool;
import vn.chuot96.dbconn.constant.SqlDeniedCmd;
...
public class SqlHandler {
    ...
    public ResponseEntity<?> execute(String driverClass, String jdbcUrl, SqlRequest request) {
        if (driverClass == null
                || driverClass.isBlank()
                || jdbcUrl == null
                || jdbcUrl.isBlank()
